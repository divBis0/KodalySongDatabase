...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { field_category_id: @field.field_category_id, name: @field.name, type: @field.type } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { field_category_id: @field.field_category_id, name: @field.name, type: @field.type } }
